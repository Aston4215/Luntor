...
print('Console KakaoTalk Lunch Indicator, Luntor 2.1.0 in Python')
print('----------------------------------------------------------------\n')
...
while(True) :
    if (now.hour == 7 and now.minute == 0 and now.second == 0 and weekday != 5 and weekday != 6) :
        ...
        while (again) :
            if (pg.locateOnScreen('Luntor 2.1.0/Chatting.png') != None) :
                pg.doubleClick(pg.center(pg.locateOnScreen('Luntor 2.1.0/Chatting.png')))
                again = 0
            elif (pg.locateOnScreen('Luntor 2.1.0/Chatting On.png') != None) :
                pg.doubleClick(pg.center(pg.locateOnScreen('Luntor 2.1.0/Chatting On.png')))
                again = 0
            elif (pg.locateOnScreen('Luntor 2.1.0/Chatting Ringing.png', confidence = 0.9) != None) :
                pg.doubleClick(pg.center(pg.locateOnScreen('Luntor 2.1.0/Chatting Ringing.png', confidence = 0.9)))
                again = 0
            elif (pg.locateOnScreen('Luntor 2.1.0/Chatting Ringing On.png', confidence = 0.9) != None) :
                pg.doubleClick(pg.center(pg.locateOnScreen('Luntor 2.1.0/Chatting Ringing On.png', confidence = 0.9)))
                again = 0
            else :
                print('Error 202 : Waiting for The Target...')
                time.sleep(1)

        while (pg.locateOnScreen('Luntor 2.1.0/Chatting Room.png') == None) :
            print('Error 202 : Waiting for The Target...')
            time.sleep(1)
        pg.doubleClick(pg.center(pg.locateOnScreen('Luntor 2.1.0/Chatting Room.png')))
        time.sleep(1)
